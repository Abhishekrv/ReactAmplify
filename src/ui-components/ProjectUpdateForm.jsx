...
export default function ProjectUpdateForm(props) {
  ...
  const resetStateValues = () => {
    ...
    setProjectAdmins(cleanValues.ProjectAdmins ?? []);
    setCurrentProjectAdminsValue("");
    setProjectMembers(cleanValues.ProjectMembers);
    setScoping(cleanValues.Scoping);
    setReporting(cleanValues.Reporting);
    setRemediation(cleanValues.Remediation);
    setErrors({});
  };
